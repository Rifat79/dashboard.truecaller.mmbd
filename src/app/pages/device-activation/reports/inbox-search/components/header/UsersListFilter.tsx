    ...
    <>
      ...
      <div className='menu menu-sub menu-sub-dropdown w-300px w-md-325px' data-kt-menu='true'>
        ...
        <div className='px-7 py-5' data-kt-user-table-filter='form'>
          ...
          {/* begin::Input group */}
          <div className='mb-10'>
            <label className='form-label fs-6 fw-bold'>IMEI :</label>
            <input  type={'number'} className='form-control' value={imei} onChange={(e) => setImei(e.target.value)}/>
              {/* <SelectSubmenu options={options} value={model} setModel={setModel}/> */}
          </div>
          {/* end::Input group */}
          <div className='mb-10 position-relative' id='date-range-ref'>
            <label className='form-label fs-6 fw-bold'>MSISDN :</label>
            <input type={'number'} className='form-control' value={msisdn} onChange={(e) => setMsisdn(e.target.value)}/>
