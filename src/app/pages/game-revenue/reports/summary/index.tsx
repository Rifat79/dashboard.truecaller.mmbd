                ...
                <div className='card card-xxl-stretch rounded' style={{backgroundColor: '#CBD4F4'}}>
                  ...
                  <div className='card-body d-flex flex-column'>
                    ...
                    <div className='d-flex align-items-center'>
                      ...
                      <div>
                        <div className='fs-1 text-dark fw-bolder lh-1'>2000</div>
                      </div>
                      {/*end::Title*/}
                    </div>
                  </div>
                ...
                <div className='card card-xxl-stretch rounded' style={{backgroundColor: '#C8BCFF'}}>
                  ...
                  <div className='card-body d-flex flex-column'>
                    ...
                    <div className='d-flex align-items-center'>
                      ...
                      {/*begin::Title*/}
                      <div>
                        <div className='fs-1 text-dark fw-bolder lh-1'>4,5K</div>
                      </div>
                      {/*end::Title*/}
                    </div>
                  </div>
                ...
                <div className='card card-xxl-stretch rounded' style={{backgroundColor: '#CBF0F4'}}>
                  ...
                  <div className='card-body d-flex flex-column'>
                    ...
                    <div className='d-flex align-items-center'>
                      ...
                      {/*begin::Title*/}
                      <div>
                        <div className='fs-1 text-dark fw-bolder lh-1'>40</div>
                      </div>
                      {/*end::Title*/}
                    </div>
                  </div>
                ...
                <div className='card card-xxl-stretch rounded' style={{backgroundColor: '#F7D9E3'}}>
                  ...
                  <div className='card-body d-flex flex-column'>
                    ...
                    <div className='d-flex align-items-center'>
                      ...
                      {/*begin::Title*/}
                      <div>
                        <div className='fs-1 text-dark fw-bolder lh-1'>5.8M</div>
                      </div>
                      {/*end::Title*/}
                    </div>
                  </div>
