...
import { GET_ACTIVATION_REPORT_SUMMARY, GET_GAME_REPORT_SUMMARY } from "../../../../../../constants/api.constants";
...
export default function() {
    ...
    const callAPI = async() => {
      const res = await getQueryRequest(GET_GAME_REPORT_SUMMARY);
    ...
    return (
        <div className='card mb-8'>
          <div className='card-body p-4'>
            <div className='row g-5 row-cols-2 row-cols-sm-2 row-cols-lg-4'>
              <div className='col'>
                <div className='card card-xxl-stretch rounded' style={{backgroundColor: '#CBD4F4'}}>
                  {/*begin::Body*/}
                  <div className='card-body d-flex flex-column'>
                    {/*begin::Wrapper*/}
                    <div className='d-flex flex-column mb-4'>
                      <p className='text-dark fw-bolder fs-3 mb-0'>Today</p>
                    </div>
                    {/*end::Wrapper*/}
                    <div className='d-flex align-items-center'>
                      ...
                      <div>
                        <div className='fs-1 text-dark fw-bolder lh-1'>{data?.today}</div>
                      </div>
                      {/*end::Title*/}
                    </div>
                  </div>
              ...
              {/* END */}
              <div className='col'>
                <div className='card card-xxl-stretch rounded' style={{backgroundColor: '#C8BCFF'}}>
                  {/*begin::Body*/}
                  <div className='card-body d-flex flex-column'>
                    {/*begin::Wrapper*/}
                    <div className='d-flex flex-column mb-4'>
                      <p className='text-dark fw-bolder fs-3 mb-0'>Last Week</p>
                    </div>
                    {/*end::Wrapper*/}
                    <div className='d-flex align-items-center'>
                      {/*begin::Symbol*/}
                      ...
                      {/*begin::Title*/}
                      <div>
                        <div className='fs-1 text-dark fw-bolder lh-1'>{data?.lastWeek}</div>
                      </div>
                      {/*end::Title*/}
                    </div>
                  </div>
              ...
              {/* END */}
              <div className='col'>
                <div className='card card-xxl-stretch rounded' style={{backgroundColor: '#CBF0F4'}}>
                  {/*begin::Body*/}
                  <div className='card-body d-flex flex-column'>
                    {/*begin::Wrapper*/}
                    <div className='d-flex flex-column mb-4'>
                      <p className='text-dark fw-bolder fs-3 mb-0'>This Month</p>
                    </div>
                    {/*end::Wrapper*/}
                    <div className='d-flex align-items-center'>
                      {/*begin::Symbol*/}
                      ...
                      {/*begin::Title*/}
                      <div>
                        <div className='fs-1 text-dark fw-bolder lh-1'>{data?.thisMonth}</div>
                      </div>
                      {/*end::Title*/}
                    </div>
                  </div>
              ...
              {/* END */}
              <div className='col'>
                <div className='card card-xxl-stretch rounded' style={{backgroundColor: '#F7D9E3'}}>
                  {/*begin::Body*/}
                  <div className='card-body d-flex flex-column'>
                    {/*begin::Wrapper*/}
                    <div className='d-flex flex-column mb-4'>
                      <p className='text-dark fw-bolder fs-3 mb-0'>Last Year</p>
                    </div>
                    {/*end::Wrapper*/}
                    <div className='d-flex align-items-center'>
                      {/*begin::Symbol*/}
                      ...
                      {/*begin::Title*/}
                      <div>
                        <div className='fs-1 text-dark fw-bolder lh-1'>{data?.lastYear}</div>
                      </div>
                      {/*end::Title*/}
                    </div>
                  </div>
