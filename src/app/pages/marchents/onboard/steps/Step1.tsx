...
const Step1: FC<{ formik: any }> = ({ formik }) => {
  const tifOptions = formik.errors && formik.errors.details && Object.keys(formik.errors.details).map(key =>
    <p className='text-danger'>{formik.errors.details[key]}</p>
  )
  return (
    <div className='w-100'>
      <div className='pb-10'>
      ...
      <div className='fv-row'>
        <div className='row row-cols-1 row-cols-lg-3'>
          <div className='col fv-row'>
            <label className='form-label mb-3'>Domain</label>
            <Field
              type='url'
            ...
            <div className='text-danger mt-2'>
              <ErrorMessage name='details.domain' />
            </div>
          </div>
          <div className='col fv-row'>
            <label className='form-label mb-3'>Mobile</label>
            <Field
              type='text'
              className='form-control form-control-lg form-control-solid'
              name='details.mobile'
            />
            <div className='text-danger mt-2'>
              <ErrorMessage name='details.mobile' />
            </div>
          </div>
          <div className='col fv-row'>
          ...
          <div className='col fv-row'>
            ...
            <div className='text-danger mt-2'>
              <ErrorMessage name='details.country' />
            </div>
          </div>
          <div className='col fv-row'>
            <label className='form-label mb-3'>Time Zone</label>
            <Field
              as='select'
              ...
              <option value="Azores">(GMT) Azores
              </option>
              <option value="Monrovia">(GMT)
                Monrovia</option>
              <option value="UTC">(GMT) UTC
              </option>
              <option value="Dublin">(GMT+01:00)
                Dublin</option>
              <option value="Edinburgh">
                (GMT+01:00) Edinburgh</option>
              <option value="Lisbon">(GMT+01:00)
                Lisbon</option>
              <option value="London">(GMT+01:00)
                London</option>
              <option value="Casablanca">
                (GMT+01:00) Casablanca</option>
              <option
                value="West Central Africa">(GMT+01:00) West Central
                Africa</option>
              ...
              <option value="Prague">(GMT+02:00)
                Prague</option>
              <option value="Sarajevo">
                (GMT+02:00) Sarajevo</option>
              <option value="Skopje">(GMT+02:00)
                Skopje</option>
              <option value="Warsaw">(GMT+02:00)
                Warsaw</option>
              <option value="Zagreb">(GMT+02:00)
                Zagreb</option>
              <option value="Brussels">
                (GMT+02:00) Brussels</option>
              <option value="Copenhagen">
                (GMT+02:00) Copenhagen</option>
              <option value="Madrid">(GMT+02:00)
                Madrid</option>
              <option value="Paris">(GMT+02:00)
                Paris</option>
              <option value="Amsterdam">
                (GMT+02:00) Amsterdam</option>
              <option value="Berlin">(GMT+02:00)
                Berlin</option>
              <option value="Bern">(GMT+02:00)
                Bern</option>
              <option value="Rome">(GMT+02:00)
                Rome</option>
              <option value="Stockholm">
                (GMT+02:00) Stockholm</option>
              <option value="Vienna">(GMT+02:00)
                Vienna</option>
              ...
              <option value="Kiev">(GMT+03:00)
                Kiev</option>
              <option value="Kyiv">(GMT+03:00)
                Kyiv</option>
              <option value="Riga">(GMT+03:00)
                Riga</option>
              <option value="Sofia">(GMT+03:00)
                Sofia</option>
              ...
              <option selected value="Asia/Dhaka">(GMT+06:00)
                Dhaka</option>
              <option value="Almaty">
            ...
            <div className='text-danger mt-2'>
              <ErrorMessage name='details.timezone' />
            </div>
          </div>
          <div className='col fv-row'>
            ...
            <div className='text-danger mt-2'>
              <ErrorMessage name='details.currency' />
            </div>
          </div>
        </div>
        <div className='row row-cols-1 row-cols-lg-2'>
          <div className='col fv-row'>
            <label className='form-label mb-3'>Office Address</label>
            <Field
              as='textarea'
              className='form-control form-control-lg form-control-solid'
              name='details.office_address'
            />
            <div className='text-danger mt-2'>
              <ErrorMessage name='details.office_address' />
            </div>
          </div>
          <div className='col fv-row'>
            <label className='form-label mb-3'>Warehouse Address</label>
            <Field
              as='textarea'
              className='form-control form-control-lg form-control-solid'
              name='details.business_address'
            />
            <div className='text-danger mt-2'>
              <ErrorMessage name='details.business_address' />
            </div>
          </div>
        </div>
        <div className='mt-1'>
