      ...
      <div className='card mb-8 mt-8'>
        ...
        <div className='card-body p-4'>
          {isLoading ? (
            ...
            <div className='row gy-4 row-cols-1 row-cols-sm-2 row-cols-lg-2'>
              <BarChart
                settings={{
                  options: {
                    chart: {
                    ...
                    xaxis: {
                      categories: data?.chart2[0]?.categories || [],
                    },
                  },
                  series: [
                    {
              ...
              <BarChart
                settings={{
                  options: {
                    ...
                    xaxis: {
                      categories: data?.chart2[1]?.categories || [],
                    },
                  },
                  series: [
                    {
