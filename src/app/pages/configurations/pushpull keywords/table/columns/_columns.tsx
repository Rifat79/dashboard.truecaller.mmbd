...
const usersColumns: ReadonlyArray<Column<User>> = [
  ...
  },
  {
    ...
    id: 'actions',
    Cell: ({...props}) => <UserActionsCell id={{id: props.data[props.row.index].id, organizationId: props.data[props.row.index].organizationId, keyword: props.data[props.row.index].brandKeyword, status:  props.data[props.row.index].status}} />,
  },
]
