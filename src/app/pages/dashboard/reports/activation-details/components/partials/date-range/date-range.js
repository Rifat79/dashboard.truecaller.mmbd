      ...
      <div className='position-relative'>
        ...
        <input
          ...
          onChange={(e) => {
            ...
            callBack({ start_date: moment(e.target.value).format('YYYY-MM-DD'), end_date: end.format('YYYY-MM-DD') });
          }}
        />
      </div>
      <div className='position-relative'>
        ...
        <input
          ...
          onChange={(e) => {
            ...
            callBack({ start_date: start.format('YYYY-MM-DD'), end_date: moment(e.target.value).format('YYYY-MM-DD') });
          }}
